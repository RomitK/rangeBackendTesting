...
class ProjectReportExport implements FromCollection, WithHeadings, WithStyles, ShouldAutoSize
{
    protected $data;
    ...
    public function collection()
    {
        ...
        $collection->push(['Project Name', 'Units Count', 'Properties Count']);

        // Add projectPropertiseWiseData
        foreach ($this->data['projectPropertiseWiseData'] as $projectData) {
            $collection->push([$projectData['name'], $projectData['units'], $projectData['properties']]);
        }
