...
class CommunityReportExport implements FromCollection, WithHeadings, WithStyles, ShouldAutoSize
{
    protected $data;
    ...
    public function collection()
    {
        ...
        $collection->push(['Community Name', 'Projects Count', 'Properties Count']);
