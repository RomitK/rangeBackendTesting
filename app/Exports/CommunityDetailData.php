...
class CommunityDetailData implements FromCollection, WithHeadings, WithStyles, ShouldAutoSize, WithTitle
{
    protected $data;
    ...
    public function collection()
    {
        return collect($this->data)->map(function ($item) {
            ...
            return [
                ...
                $item['projects']->count(),
                countPropertiesForCommunity($item['id']),
                $item['status'],
                $item['is_approved'],
                $approvalName,
                $userName,
    ...
    {
        return 'Communities Data'; // Set the name for this subsheet
    }
}
