...
class ProjectReportAndEmailData implements ShouldQueue
{
    ...
    {
        Log::info('projectReport');

        $export = new ProjectReportExport($this->data);
        ...
        Mail::to($email)->send(new ProjectDataExportMail($excelFile, $this->data['userName']));
    }
}
