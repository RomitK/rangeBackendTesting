...
use App\Exports\ProjectLogDataExport;
use App\Mail\ProjectLogExportMail;
use Maatwebsite\Excel\Facades\Excel;
use Illuminate\Support\Facades\Log;

class ProjectLogExportAndEmailData implements ShouldQueue
{
    ...
    {
        $export = new ProjectLogDataExport($this->collection);
        ...
        Mail::to($email)->send(new ProjectLogExportMail($excelFile, $this->request['userName']));
    }
}
