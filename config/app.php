...
return [
    ...
    */
    ...
    'mortgage_api_url_uta' => env('MORTGAGE_API_URL_UTA', 'http://65.0.31.40:88/api/'),

    'mortgage_token_uta' => env('MORTGAGE_LEAD_TOKEN_UTA', 'my_mortgage_api_Obs1ykgU6K2MB9AteHYBApcH'),
