                        ...
                        <div class="col-12 col-lg-8 col-md-8">
                            ...
                            <div class="mb-3">
                                    ...
                                    <div class="swiper-wrapper">
                                       @foreach ($property->propertygallery as $img)
                                        <div class="swiper-slide">
                                            <img src="{{ $img->galleryimage }}" alt="{{ $property->name }}"
                                                class="img-fluid" />
                                        </div>
                                        @endforeach
                                        <div class="swiper-slide">
                                ...
                                <div thumbsSlider="" class="swiper swiperThumb1 pt-3">
                                    <div class="swiper-wrapper">
                                        @foreach ($property->propertygallery as $imgs)
                                        <div class="swiper-slide">
                                            <img src="{{ $img->galleryimage }}" alt="{{ $property->name }}"
                                                class="img-fluid"/>
                                        </div>
                        ...
                        <div class="col-12 col-lg-4 col-md-4">
                            <div class="bg-light px-3 py-2 mb-5">
                                <div class="border-bottom border-2 py-3">
                                    ...
                                    <p class="fw-500 mb-0">{{  $property->category? $property->category->name:''}}</p>
                                </div>
                                <div class="border-bottom border-2 py-3">
                                    <p class="text-primary fw-500 mb-1 fs-20">PROPERTY TYPE</p>
                                    <p class="fw-500 mb-0">{{ $property->accommodations?$property->accommodations->name:''}}</p>
                                </div>
                                <div class="border-bottom border-2 py-3">
                                    <ul class="list-unstyled">
                                        <li class="mb-2">
                                            <small><img src="{{ asset('frontend/assets/images/icons/bed-blue.png') }}"
                                                ...
                                                <span class="align-text-top ms-2 fs-16 fw-500">
                                        ...
                                        <li class="mb-2">
                                            <small><img src="{{ asset('frontend/assets/images/icons/bath-blue.png') }}"
                                                    alt="Range" class="img-fluid" width="30px">
                                                <span class="align-text-top ms-2 fs-16 fw-500">{{$property->bathrooms}}</span></small>
                                        </li>
                                        <li class="mb-2">
                                        ...
                                        <li class="mb-2">
                                            <small><img src="{{ asset('frontend/assets/images/icons/area-blue.png') }}"
                                                    alt="Range" class="img-fluid" width="30px">
                                                <span class="align-text-top ms-2 fs-16 fw-500">{{$property->area}}
                                                    sq.ft.</span></small>
                                        </li>
                                        <li class="mb-2">
                                            <small><img src="{{ asset('frontend/assets/images/icons/building.png') }}"
                                                    alt="Range" class="img-fluid" width="30px">
                                                <span class="align-text-top ms-2 fs-16 fw-500">{{$property->communities->name}}</span></small>
                                        </li>
                                        <li class="">
                                    ...
                                    <div class="d-flex justify-content-start py-3">
                                        ...
                                        <div class="my-auto">
                                            <div class="projectSpec  text-uppercase">
                                                <p class="mb-0">AED {{ number_format($property->price)}}</p>
                                                <p class="text-primary mb-0 fs-20">Price</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
