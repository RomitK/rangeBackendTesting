                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit Media Form</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-boder" id="storeForm"  method="POST" action="{{ route('dashboard.articles.update', $article->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $article->title }}" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Enter Title" name="title" required>
                                            @error('title')
                                    ...
                                    <!--        <input type="text" value="{{ $article->author }}" class="form-control @error('author') is-invalid @enderror" id="author" placeholder="Enter Author Name" name="author" required>-->
                                    <!--        @error('author')-->
                                    <!--            <span class="invalid-feedback" role="alert">-->
                                    <!--                <strong>{{ $message }}</strong>-->
                                    <!--            </span>-->
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select1 @error('status') is-invalid @enderror" id="status" name="status" required>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $article->article_event }}" class="form-control @error('article_event') is-invalid @enderror" id="article_event" placeholder="Enter Media Event" name="article_event" required>
                                            @error('article_event')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="{{ date('Y-m-d', strtotime($article->publish_at)) }}" class="form-control @error('publish_at') is-invalid @enderror" id="publish_at" name="publish_at" required>
                                            @error('publish_at')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $article->mediaOrder }}"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $article->meta_title }}"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $article->meta_keywords }}"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description"
                                                placeholder="Enter Meta Description" name="meta_description">{{ $article->meta_description }}</textarea>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('short_content') is-invalid @enderror" name="short_content">{{$article->short_content}}</textarea>
                                            @error('short_content')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote" class="form-control @error('content') is-invalid @enderror" name="content">{!! $article->content !!}</textarea>
                                            @error('content')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <img src="{{ $article->mainImage }}" alt="{{ $article->title }}" width="100" height="100">
                                            @endif
                                            @error('mainImage')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            @if($article->additionalImage)
                                            <img src="{{ $article->additionalImage }}" alt="{{ $article->title }}" width="100" height="100">
                                            @endif
                                     ...
                                     <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $article->article_additional_video }}"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <table id="items" class="table table-no-more table-bordered mb-none ">
                                            <thead>
                                                ...
                                                @php 
                                                    $total_gallery_row_count = count($article->imageGallery);
                                                    $count = 0;
                                                @endphp
                                               
                                                @if (count($article->imageGallery) > 0)
                                                    @foreach ($article->imageGallery as $gallery)
        ...
        function deleteGallery(id) {
            ...
            if (confirm('This Data is saved ! Are you sure you want to delete this?')) {
                $.ajax({
                    ...
                    url: '{{ url('/') }}/dashboard/articles/' + articleId+'/media/'+id,
                    data: {
                        "_token": "{{ csrf_token() }}"
                    },
                    type: 'GET',
