                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $career->location }}" 
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select1 @error('type') is-invalid @enderror" id="type" name="type">
                                                <option value="Full Time" @if ($career->type === 'Full Time') selected @endif>Full Time</option>
                                                <option value="Part Time" @if ($career->type === 'Part Time') selected @endif>Part Time</option>
                                            </select>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control @error('short_description') is-invalid @enderror" id="" name="short_description">{{ $career->short_description }}</textarea>
                                    ...
                                    <div class="col-sm-12">
                                     ...
                                     <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="summernote form-control @error('assistance') is-invalid @enderror" id="assistance" name="assistance">{{ $career->assistance }}</textarea>
                                            @error('assistance')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="summernote form-control @error('benefits') is-invalid @enderror" id="benefits" name="benefits">{{ $career->benefits }}</textarea>
                                            @error('benefits')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
