        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-boder" method="POST" action="{{ route('dashboard.guides.store') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file   @error('sliderImage') is-invalid @enderror">
                                            <input type="file" class="custom-file-input  @error('sliderImage') is-invalid @enderror" id="sliderImage" name="sliderImage" accept="image/*" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file   @error('featureImage') is-invalid @enderror">
                                            <input type="file" class="custom-file-input  @error('featureImage') is-invalid @enderror" id="featureImage" name="featureImage" accept="image/*" required>
