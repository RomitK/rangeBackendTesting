            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">New {{ config('constants.'.$page.'.title') }} Page FAQS</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">New {{ config('constants.'.$page.'.title') }} Page FAQS Form</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-boder" method="POST"
                        action="{{ route('dashboard.faqs.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('question') }}" class="form-control @error('question') is-invalid @enderror" id="question" placeholder="Enter Question" name="question" required>
                                            @error('question')
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="long_answer"
                                                class="summernote form-control @error('long_answer') is-invalid @enderror" name="long_answer">{{ old('long_answer') }}</textarea>
                                            @error('long_answer')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
