...
@section('content')
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <form class="form-boder" id="storeForm" method="POST"
                            action="{{ route('dashboard.communities.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select1 @error('emirate') is-invalid @enderror"
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ old('communityOrder') }}"
                                                class="form-control @error('communityOrder') is-invalid @enderror"
                                                id="communityOrder" name="communityOrder" min="1">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="highlights">Highlights<small class="text-danger">(At least 4
                                                    Highlights )</small></label>
                                            <select multiple="multiple" data-placeholder="Select Highlights"
                                                style="width: 100%;"
                                                class="select2 form-control @error('highlightIds') is-invalid @enderror"
                                                id="highlights" name="highlightIds[]">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="shortDescription">Short Description<small class="text-danger">(Not
                                                    more 300 characters)</small></label>
    ...
    @enderror-->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="mainImage">Home Page Image <small
                                                    class="text-danger">(400x400)</small></label>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="masterPlan">Master Plan <small class="text-danger">(Prefer
                                                    Dimension 600X1000)</small></label>
                                            <div
                                                class="custom-file   @error('clustmasterPlanerPlan') is-invalid @enderror">
                                                <input type="file"
                                                    class="custom-file-input   @error('masterPlan') is-invalid @enderror"
                                                    id="masterPlan" name="masterPlan" accept="image/*">
                                                <label class="custom-file-label" for="masterPlan">Choose file</label>
                                            </div>
                                            <img id="masterPlanPreview"
                                                style="max-width: 100%; height: 100px; display: none;" />
                                            @error('masterPlan')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
