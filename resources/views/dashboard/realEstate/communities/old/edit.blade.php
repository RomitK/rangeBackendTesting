                        ...
                        <form class="form-boder" id="storeForm" method="POST" 
                            ...
                            <div class="card-body">
                                <div class="row">
                                  ...
                                  <!--<div class="col-sm-6">-->
                                  <!--      <div class="form-group">-->
                                  <!--          <label for="developerIds">Select Parent Community</label>-->
                                  <!--          <select data-placeholder="Select Parent Community"-->
                                  <!--              style="width: 100%;"-->
                                  <!--              class="select1 form-control @error('parent_id') is-invalid @enderror"-->
                                  <!--              id="parent_id" name="parent_id">-->
                                  <!--             <option></option>-->
                                  <!--              @foreach ($communities as $parentCommunity)-->
                                  <!--                  <option value="{{ $parentCommunity->id }}"  @if ($parentCommunity->id === $community->parent_id) selected @endif> {{ $parentCommunity->name }}</option>-->
                                  <!--              @endforeach-->
                                  <!--          </select>-->
                                  <!--          @error('parent_id')-->
                                  <!--              <span class="invalid-feedback" role="alert">-->
                                  ...
                                  <!--  </div>-->
                                    ...
                                    <!--            @foreach ($tags as $tag)-->
                                    <!--                <option value="{{ $tag->id }}"-->
                                    <!--                    @if (in_array($tag->id,$community->tags()->pluck('tag_category_id')->toArray())) selected @endif>-->
                                    <!--                    {{ $tag->name }}</option>-->
                                    <!--            @endforeach-->
                                    <!--        </select>-->
                                    <!--        @error('tagIds')-->
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select multiple="multiple" data-placeholder="Select Amenities" style="width: 100%;" class="select2 form-control @error('amenityIds') is-invalid @enderror" id="amenities" name="amenityIds[]">
                                                <!--@foreach ($amenities as $amenity)-->
                                                <!--<option value="{{ $amenity->id }}" @if(in_array($amenity->id, $community->amenities->pluck('id')->toArray())) selected @endif>{{ $amenity->name }}</option>-->
                                                <!--@endforeach-->
                                    ...
                                    <!--            placeholder="Enter Location Iframe" name="location_iframe">{{ $community->location_iframe }}</textarea>-->
                                    ...
                                    <div class="col-sm-12">
                                     ...
                                     <div class="col-sm-4">
                                        ...
                                        @if ($community->mainImage)
                                            <img src="{{ $community->mainImage }}" alt="{{ $community->mainImage }}"  height="200">
                                        @endif
                                    </div>
                                    <!--<div class="col-sm-4">-->
                                    <!--    <div class="form-group">-->
                                    ...
                                    <!--                    style="padding: 10px" height="200" style="height:200px !Important">-->
                                    ...
                                    <!--            </span>-->
                                    <!--        @enderror-->
                                    <!--        @if($community->listMainImage)-->
                                    <!--        <img src="{{ $community->listMainImage }}" alt="{{ $community->listMainImage }}" width="" height="200">-->
                                    <!--        @endif-->
                                    <!--    </div>-->
                                    <!--</div>-->
