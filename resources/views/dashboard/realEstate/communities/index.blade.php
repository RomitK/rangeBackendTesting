                        ...
                        <div class="card-body table-responsive">
                            ...
                            <form method="GET">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="community_source">Community Source</label>
                                            <select class="form-control" id="community_source" name="community_source">
                                                @foreach (config('constants.propertySourcesWithAll') as $key => $value)
                                                    <option value="{{ $key }}"
                                                        @if (request()->community_source == $key) selected @endif>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                        </div>
