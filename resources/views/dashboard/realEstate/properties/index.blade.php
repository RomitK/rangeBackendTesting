                                   ...
                                   <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"
                                                id="updated_brochure" name="updated_brochure">
                                     ...
                                     <div class="col-sm-3">
                                        <label for="keyword"> Keyword</label>
                                            <input type="text" value="{{ request()->keyword }}"
                                                ...
                                                placeholder="Enter Name, Reference Number" name="keyword">
                                     </div>
                                  </div>
                                   <br>
                                  <div class="row">
                                            ...
                                            <td class="project-actions text-right">
                                                <form method="POST"
                                                    ...
                                                    <a class="btn btn-dark btn-sm"
                                                        href="{{ route('dashboard.properties.updateBrochure', $property->id) }}" target="_blanket">
                                                   ...
                                                   @if($property->brochure)
                                                    <a class="btn btn-dark btn-sm"
                                                        href="{{ $property->brochure }}" target="_blanket">
                                                   ...
                                                   @endif
                                                    ...
                                                    <a class="btn btn-dark btn-sm"
                                                        href="{{ $property->saleOffer }}" target="_blanket">
                                                        <i class="fas fa-file"></i>
                                                         View Sale Offer
                                                    </a>
                                                   @endif
