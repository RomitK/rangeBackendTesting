                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <form method="GET">
                            ...
                            $seletectAccommodations =request()->accommodation_ids?request()->accommodation_ids:[] ;
                            $seletectUpdatedUsers = request()->updated_user_ids? request()->updated_user_ids:[];
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="exclusive" name="exclusive">
                                            ...
                                            <option value="{{ $key }}" @if(request()->exclusive == $key) selected @endif>{{ $value }}</option>
                                            @endforeach
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select1 @error('is_furniture') is-invalid @enderror" id="is_furniture" name="is_furniture">
                                            ...
                                            <option value="{{ $key }}" @if(request()->is_furniture === $key) selected @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="property_source" name="property_source">
                                            ...
                                            <option value="{{ $key }}" @if(request()->property_source == $key) selected @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select data-placeholder="Select Completion Status" style="width: 100%;" class=" form-control select1" id="completion_status_id" name="completion_status_id">
                                            @foreach ($completionStatuses as $key=>$value)
                                            <option value="{{ $key }}" @if(request()->completion_status_id == $key) selected @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select multiple="multiple" data-placeholder="Select Project" style="width: 100%;" class="select2 form-control @error('project_id') is-invalid @enderror" id="project_id" name="project_ids[]">
                                            @foreach ($projects as $key=>$project)
                                            <option value="{{ $key }}" @if (in_array($key, $seletectProjects)) selected @endif>{{ $project }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select multiple="multiple" data-placeholder="Select Property Type" style="width: 100%;" class="select2 form-control select1" id="accommodation_ids" name="accommodation_ids[]">
                                            @foreach ($accommodations as $key=>$value)
                                            <option value="{{ $key }}" @if (in_array($key, $seletectAccommodations)) selected @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="updated_brochure" name="updated_brochure">
                                            ...
                                            <option value="1" @if(request()->updated_brochure === '1') selected @endif>Updated</option>
                                            <option value="0" @if(request()->updated_brochure === '0') selected @endif>Need to Update</option>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select multiple="multiple" data-placeholder="Select Agent" style="width: 100%;" class="select2 form-control select1" id="agent_id" name="agent_ids[]">
                                            @foreach ($agents as $value)
                                            <option value="{{ $value->id }}" @if (in_array($value->id, $seletectAgents)) selected @endif>{{ $value->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select multiple="multiple" data-placeholder="Select User" style="width: 100%;" class=" form-control select1" id="added_user_ids" name="added_user_ids[]">
                                            @foreach ($users as $key=>$value)
                                            <option value="{{ $key }}" @if (in_array($key, $seletectAddedUsers)) selected @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select multiple="multiple" data-placeholder="Select User" style="width: 100%;" class=" form-control select1" id="updated_user_ids" name="updated_user_ids[]">
                                            @foreach ($users as $key=>$value)
                                            <option value="{{ $key }}" @if (in_array($key, $seletectUpdatedUsers)) selected @endif>{{ $value }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" value="{{ request()->keyword }}" class="form-control" id="keyword" placeholder="Enter Name, Reference Number" name="keyword">
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a class="btn btn-block btn-warning search_clear_btn" href="{{ url('dashboard/properties') }}">Clear Search</a>
                                    @endif
                                </div>
                        ...
                        <table class="table table-hover text-nowrap table-striped propertyDatatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Property Type</th>
                                    <th>Status</th>
                                    <th>Order Number <span class="arrow up" onclick="orderBy('propertyOrder', 'asc')">&#x25B2;</span><span class="arrow down" onclick="orderBy('propertyOrder', 'desc')">&#x25BC;</span></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <span class="badge @if ($property->exclusive === 1) bg-success @else bg-danger @endif">
                                    ...
                                    <td class="project-actions text-right">
                                        <form method="POST" action="{{ route('dashboard.properties.destroy', $property->id) }}">
                                            @csrf
                                            @method('DELETE')

                                            <a class="btn btn-warning btn-sm" target="_blanket" href="{{ config('app.frontend_url')."properties/".$property->slug }}">
                                                <i class="fas fa-eye"></i>
                                                View
                                            </a>

                                            @if($property->updated_brochure ==0 && in_array(Auth::user()->role, config('constants.isAdmin')))
                                            <a class="btn btn-dark btn-sm" href="{{ route('dashboard.properties.updateBrochure', $property->id) }}" target="_blanket">
                                                <i class="fas fa-road"></i>
                                                Update Brochure
                                            </a>
                                            @endif
                                            @if($property->brochure)
                                            <a class="btn btn-dark btn-sm" href="{{ $property->brochure }}" target="_blanket">
                                            ...
                                            <a class="btn btn-dark btn-sm" href="{{ $property->saleOffer }}" target="_blanket">
                                                <i class="fas fa-file"></i>
                                                View Sale Offer
                                            </a>
                                            @endif
                                            ...
                                            <a class="btn btn-primary btn-sm" href="{{ route('dashboard.properties.duplicate', $property->id) }}">
                                                <i class="fas fa-file"></i>
                                                Duplicate
                                            </a>
