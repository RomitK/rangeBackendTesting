                        ...
                        <form class="form-boder" id="storeForm" method="POST" action="{{ route('dashboard.properties.update', $property->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <!--                <option value="{{ $value->id }}" @if($value->id == $property->community_id) selected @endif>{{ $value->name }}</option>-->
                                    <!--            @endforeach-->
                                    <!--        </select>-->
                                    <!--        @error('community_id')-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select data-placeholder="Select Project" style="width: 100%;" class="select2 form-control @error('project_id') is-invalid @enderror" id="project_id" name="project_id" required>
                                                ...
                                                @foreach ($projects as $value)
                                                    <option value="{{ $value->id }}" @if($value->id == $property->project_id) selected @endif>{{ $value->title }}  ( {{$value->developer->name}})</option>
                                                @endforeach
                                            </select>
                                            @error('project_id')
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('is_approved') is-invalid @enderror" id="is_approved" name="is_approved">
                                                ...
                                                <option value="{{ $key }}" @if($key === $property->is_approved) selected @endif>{{ $value }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $property->name }}" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter Name" name="name" required>
                                            @error('name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <!--        <p  class="form-control @error('reference_number') is-invalid @enderror" id="reference_number" placeholder="Enter Reference Number" name="reference_number">{{ $property->reference_number }}</p>-->
                                    ...
                                    <!--<div class="col-sm-3">-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label for="new_reference_number">Reference Number</label>-->
                                    <!--        <input type="text" value="{{ $property->new_reference_number }}" class="form-control @error('reference_number') is-invalid @enderror" id="new_reference_number" placeholder="Enter Reference Number" name="new_reference_number" readonly>-->
                                    <!--        @error('new_reference_number')-->
                                    <!--            <span class="invalid-feedback" role="alert">-->
                                    <!--                <strong>{{ $message }}</strong>-->
                                    <!--            </span>-->
                                    <!--        @enderror-->
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="propertyOrder">Property By</label>
                                            <input type="number" value="{{ $property->propertyOrder }}" min="0"
                                                ...
                                                placeholder="Enter propertyOrder" name="propertyOrder">
                                            @error('propertyOrder')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select1 @error('accommodation_id') is-invalid @enderror" id="accommodation_id"
                                                ...
                                                @foreach ($accommodations as $key=>$value)
                                                    <option value="{{ $value->id }}" @if($property->accommodation_id === $value->id) selected @endif>{{ $value->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" value="{{$property->area }}" class="form-control @error('area') is-invalid @enderror" id="area"  name="area" step="any">
                                            @error('area')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $property->price }}" class="form-control @error('price') is-invalid @enderror" id="price"  name="price">
                                            @error('price')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select1 @error('rental_period') is-invalid @enderror"
                                                ...
                                                <option value="Monthly" @if($property->rental_period == "Monthly" ) selected @endif>Monthly</option>
                                                <option value="Yearly"  @if($property->rental_period == "Yearly" ) selected @endif>Yearly</option>
                                            </select>
                                            @error('rental_period')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select1 @error('is_luxury_property') is-invalid @enderror" id="is_luxury_property" name="is_luxury_property">
                                                @foreach (config('constants.booleanOptions') as $key=>$value)
                                                <option value="{{ $key }}"  @if($property->is_luxury_property == $key) selected @endif>{{ $value }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <!--            <a href="{{ $property->saleOffer }}" download="">Download Sale Offer</a>-->
                                    <!--        @endif-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    ...
                                    <!--                    <div class="row"> -->
                                    <!--                        @foreach ($property->floorplans as $key=>$img)-->
                                    <!--                         <div class="card col-md-4">-->
                                    <!--                             <div class="image-area" stye="width:100% !important">-->
                                    <!--                                <a href="{{ $img['path'] }}" data-toggle="lightbox" data-title="Floor-Plan" data-gallery="gallery">-->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            @if ($property->property_banner)
                                                <img src="{{ $property->property_banner }}" alt="{{ $property->property_banner }}" height="100">
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                                ...
                                                <div class="container"> 
                                                    <div class="card-group"> 
                                                        <div class="row"> 
                                                            ...
                                                            <div class="card col-md-4">
                                                                 <div class="image-area" stye="width:100% !important">
                                                                    <a href="{{ $img['galleryimage'] }}" data-toggle="lightbox" data-title="Sub Images" data-gallery="gallery">
                                                                    <img src="{{ $img['galleryimage'] }}" alt="{{ $img['galleryimage'] }}" width="" height="100" style="padding: 10px">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            @endif
                                            ...
                                            <thead>
                                                ...
                                                @if (count($property->subImages) > 0)
                                                    @foreach ($property->subImages as $gallery)
                                                        ...
                                                        <tr class="item-row">
                                                            <td>
                                                                <input type="hidden" name="subImages[{{ $count }}][old_gallery_id]" value="{{ $gallery['id'] }}">
                                                                <img src="{{ $gallery['path'] }}" alt="{{ $gallery['path'] }}" width="" height="100" style="padding: 10px">
                                                            </td>
                                                            <td>
                                                                <input type="text" value="{{ $gallery['title'] }}" class="form-control" placeholder="Enter Title" name="subImages[{{ $count }}][title]">
                                                            </td>
                                                            <td>
                                                                <input type="number" min="0" value="{{ $gallery['order'] }}" class="form-control" placeholder="Enter Order" name="subImages[{{ $count }}][order]" >
                                                            </td>
                                                ...
                                                @else
                                                    <tr class="item-row" style="border-bottom: solid 1px black">
                                                        <td>
                                                            <input type="hidden" name="subImages[{{ $count }}][old_gallery_id]" value="0">
                                                            <div class="custom-file   @error('gallery') is-invalid @enderror">
                                                                <input type="file" class="custom-file-input @error('gallery') is-invalid @enderror" id="gallery" name="subImages[0][file]" accept="image/*" onchange="previewImage(event)">
            ...
            $("#addrow").click(function() {
                ...
                $(".item-row:last").after('<tr class="item-row" style="border-bottom: solid 1px black">' +
                    ...
                    '<td data-title="Action" class="main_td">' +
                        '<a class="Remove mybtn btn btn-danger btn-sm" href="javascript:;"  title="Remove row"> x Remove</a>' +'</td><input type="hidden"  name="subImages[' + id +
