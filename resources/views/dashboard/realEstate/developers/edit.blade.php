                        ...
                        <form class="form-boder" id="storeForm" files="true" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('is_approved') is-invalid @enderror" id="is_approved" name="is_approved">
                                                ...
                                                <option value="{{ $key }}" @if($key === $developer->is_approved) selected @endif>{{ $value }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select1 @error('display_on_home') is-invalid @enderror" id="display_on_home" name="display_on_home" required>
                                                <option value="1" @if ($developer->display_on_home == 1) selected @endif>Yes</option>
                                                <option value="0" @if ($developer->display_on_home == 0) selected @endif>No</option>
                                            </select>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $developer->developerOrder }}" min="0"
                                                class="form-control @error('developerOrder') is-invalid @enderror" id="developerOrder"
                                                placeholder="Enter developerOrder" name="developerOrder">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="logo">Logo<small class="text-danger">(Prefer Size 427x198, SVG)</small></label>
                                            <div class="custom-file   @error('logo') is-invalid @enderror">
                                                <input type="file" class="custom-file-input" id="logo" name="logo" accept="image/*" >
                                                <label class="custom-file-label" for="logo">Choose file</label>
                                            </div>
                                            @if($developer->logo )
                                            <img src="{{ $developer->logo }}" alt="{{ $developer->name }}" height="198" width="380" >
                                            @endif
                                            @error('logo')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <!--        @enderror-->
                                    <!--        @if($developer->image )-->
                                    <!--        <img src="{{ $developer->image }}" alt="{{ $developer->image }}" height="200">-->
                                    <!--        @endif-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    ...
                                    <!--        @if($developer->gallery)-->
                                    <!--        <br><br>-->
                                    <!--            @if (count($developer->gallery) > 1)-->
                                    <!--                <a class="btn btn-danger btn-sm float-right col-md-12 mb-2"-->
                                    <!--                onclick="return confirm('Are you sure to delete all images?')" href="{{ route('dashboard.developers.medias.delete', $developer->id) }}">-->
                                    ...
                                    <!--            @endif-->
                                    <!--            <div class="row">-->
                                    <!--                @foreach ($developer->gallery as $img)-->
                                    <!--            <div class="col-md-6">-->
                                    <!--                <div class="image-area">-->
                                    <!--                <img src="{{ $img['path'] }}" alt="{{ $img['path'] }}" width="" height="100" style="padding: 10px">-->
                                    <!--                <a class="remove-image" onclick="return confirm('Are you sure to delete the image?')" href="{{ route('dashboard.developers.media.delete', [$developer->id,$img['id'] ]) }}" style="display: inline;">&#215;</a>-->
                                    <!--            </div>-->
                                    <!--            </div>-->
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="short_description">Description<small class="text-danger">(Not more 400 characters)</small></label>
    ...
    $(document).ready(function() {
        ...
        $("#addrow").click(function() {
            ...
            $(".item-row:last").after('<tr class="item-row" style="border-bottom: solid 1px black">' +
                ...
                '</td>' +
                '<td class="main_td"><input type="text" class="form-control" placeholder="Enter Title" name="gallery[' + id +'][title]" required></td>' +
