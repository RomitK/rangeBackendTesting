                        ...
                        <form method="GET">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a class="btn btn-block btn-warning search_clear_btn" href="{{ url('dashboard/developers') }}">Clear Search</a>
                                    @endif
                                </div>
                        ...
                        <table class="table table-hover text-nowrap table-striped propertyDatatable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Logo</th>
                                    <th>Status</th>
                                    <th>Order Number <span class="arrow up" onclick="orderBy('developerOrder', 'asc')">&#x25B2;</span><span class="arrow down" onclick="orderBy('developerOrder', 'desc')">&#x25BC;</span></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                @if ($developer->logo)
                                                <img alt="{{ $developer->name }}" class="table-avatar" width="100" src="{{ $developer->logo }}">
                                                @endif
                                            </li>
                                        </ul>
                                    </td>
                                    ...
                                    <td class="project-actions text-right">
                                        <form method="POST" action="{{ route('dashboard.developers.destroy', $developer->id) }}">
                                            ...
                                            <a class="btn btn-warning btn-sm" target="_blanket" href="{{ config('app.frontend_url')."developers/".$developer->slug }}">
                                            ...
                                            <a class="btn btn-secondary btn-sm" href="{{ route('dashboard.developer.meta', $developer->id) }}">
                                                <i class="fas fa-database"></i>
                                                Meta Details
                                            </a>
                                            @endcan

                                            <a class="btn btn-info btn-sm" href="{{ route('dashboard.developers.edit', $developer->id) }}">
