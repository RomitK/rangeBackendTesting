        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-boder" id="storeForm" method="POST" action="{{ route('dashboard.developer.meta.store', $developer->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="meta_title">Slug <small class="text-danger">(Example: {{ Str::slug($developer->name) }})</small></label>
                                        <input type="text" value="{{ $developer->slug }}" class="form-control @error('slug') is-invalid @enderror" id="slug" placeholder="Enter Slug" name="slug">
                                        @error('slug')
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $developer->meta_title }}" class="form-control @error('meta_title') is-invalid @enderror" id="meta_title" placeholder="Enter Meta Title" name="meta_title">
                                        @error('meta_title')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $developer->meta_keywords }}" class="form-control @error('meta_keywords') is-invalid @enderror" id="meta_keywords" placeholder="Enter Meta Keywords" name="meta_keywords">
                                        @error('meta_keywords')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description" placeholder="Enter Meta Description" name="meta_description">{{ $developer->meta_description }}</textarea>
