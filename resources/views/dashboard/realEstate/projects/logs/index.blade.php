...
@section('breadcrumb')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Project Log History</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/home">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ url('dashboard/projects') }}">Projects</a></li>
                        <li class="breadcrumb-item active">Project Log History</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        @if (count($project->logActivity) > 0)
                            <div class="card-header">
                                <div class="row float-right">
                                    <div class="col-md-12">
                                        <a class="btn btn-block btn-info" id="exportDeveloperLog"
                                            href="{{ route('dashboard.projects.logs', ['project' => $project->id, 'export' => 1]) }}">Download</a>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="card-body">
                            <table class="table table-hover text-nowrap table-striped datatable">
                                ...
                                <tbody>
                                    @foreach ($project->logActivity as $key => $value)
                                        @php
