                                ...
                                <div class="row">
                                                ...
                                                <select data-placeholder="Select Community"
                                                    ...
                                                    @foreach ($communities as $community)
                                                        <option value="{{ $community->id }}"
                                                            @if ($project->community_id == $community->id) selected @endif>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror"
                                                ...
                                                @foreach (config('constants.statuses') as $key => $value)
                                                    <option value="{{ $key }}"
                                                        @if ($project->status == $key) selected @endif>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                            @error('status')
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('is_display_home') is-invalid @enderror"
                                                ...
                                                <option value="1" @if ($project->is_display_home == 1) selected @endif>
                                                    Yes
                                                </option>
                                                <option value="0" @if ($project->is_display_home == 0) selected @endif>
                                                    No
                                                </option>
                                            </select>
                                            ...
                                            <select data-placeholder="Select Completion Status" style="width: 100%;"
                                                ...
                                                @foreach ($completionStatuses as $value)
                                                    <option value="{{ $value->id }}"
                                                        @if ($project->completion_status_id == $value->id) selected @endif>
                                                        {{ $value->name }}</option>
                                                @endforeach
                                            </select>
                                                    ...
                                                    <select data-placeholder="Select Accommodation" style="width: 100%;"
                                                        ...
                                                        @foreach ($accommodations as $accommodation)
                                                            <option value="{{ $accommodation->id }}"
                                                                @if ($accommodation->id == $project->accommodation_id) selected @endif>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select1 @error('used_for') is-invalid @enderror"
                                                ...
                                                @foreach (config('constants.accommodationType') as $key => $value)
                                                    <option value="{{ $key }}"
                                                        @if ($key === $project->type) selected @endif>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                            @error('used_for')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                @foreach (config('constants.propertySources') as $value)
                                                    <option value="{{ $value }}"
                                                        @if ($project->project_source == $value) selected @endif>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="features_description"
                                                class="summernote form-control @error('features_description') is-invalid @enderror" name="features_description">{{ $project->features_description }}</textarea>
                                            ...
                                            <select multiple="multiple" data-placeholder="Select Amenities"
                                                ...
                                                @foreach ($amenities as $amenity)
                                                    <option value="{{ $amenity->id }}"
                                                        @if (in_array($amenity->id, $project->amenities->pluck('id')->toArray())) selected @endif>
                                                        {{ $amenity->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('amenities')
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            @if ($project->mainImage)
                                                <img src="{{ $project->mainImage }}" alt="{{ $project->mainImage }}"
                                                    width="" height="100">
                                            @endif
                                    ...
                                    <div class="col-sm-12">
                                        <table id="items" class="table table-no-more table-bordered mb-none ">
                                            ...
                                            @if (count($project->exteriorGallery) > 0)
                                                @foreach ($project->exteriorGallery as $exteriorGallery)
                                                    <tr class="exterior-item-row">
                                                        <td>
                                                            <input type="hidden"
                                                                name="exteriorGallery[{{ $exterior_count }}][old_gallery_id]"
                                                                value="{{ $exteriorGallery['id'] }}">
                                                            <img src="{{ $exteriorGallery['path'] }}"
                                                                alt="{{ $exteriorGallery['path'] }}" width=""
                                                                height="100" style="padding: 10px">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="{{ $exteriorGallery['title'] }}"
                                                                class="form-control" placeholder="Enter Title"
                                                                name="exteriorGallery[{{ $exterior_count }}][title]">
                                                        </td>
                                                        <td>
                                                            <input type="number" min="0"
                                                                value="{{ $exteriorGallery['order'] }}"
                                                                class="form-control" placeholder="Enter Order"
                                                                name="exteriorGallery[{{ $exterior_count }}][order]">
                                                        </td>

                                                        <td>

                                                            <a class="btn btn-sm btn-danger" id="fix_delete"
                                                                onclick="deleteGallery({{ $exteriorGallery['id'] }})"
                                                ...
                                                <tr class="exterior-item-row" style="border-bottom: solid 1px black">
                                                    <td>
                                                        ...
                                                        <div
                                                            ...
                                                            <label class="custom-file-label" for="exteriorGallery">Choose
                                                                file</label>
                                                        </div>
                                            ...
                                            <tr id="hiderow">
                                                <td colspan="16">
                                                    <a id="addRowExterior" href="javascript:;"class="btn btn-info btn-sm"
                                    ...
                                    <div class="col-sm-12">
                                        <table id="items" class="table table-no-more table-bordered mb-none ">
                                            <thead>
                                                <tr>
                                                    <th colspan="4">
                                                        <label for="interiorGallery">Interior Gallery<small
                                                                class="text-danger">(Prefer Size 600x600)</small></label>
                                                    </th>
                                                </tr>
                                                <tr style="">
                                                    <th>Image</th>
                                            ...
                                            @if (count($project->interiorGallery) > 0)
                                                @foreach ($project->interiorGallery as $interiorGallery)
                                                    <tr class="interior-item-row">
                                                        <td>
                                                            <input type="hidden"
                                                                name="interiorGallery[{{ $interior_count }}][old_gallery_id]"
                                                                value="{{ $interiorGallery['id'] }}">
                                                            <img src="{{ $interiorGallery['path'] }}"
                                                                alt="{{ $interiorGallery['path'] }}" width=""
                                                                height="100" style="padding: 10px">
                                                        </td>
                                                        <td>
                                                            <input type="text" value="{{ $interiorGallery['title'] }}"
                                                                class="form-control" placeholder="Enter Title"
                                                                name="interiorGallery[{{ $interior_count }}][title]">
                                                        </td>
                                                        <td>
                                                            <input type="number" min="0"
                                                                value="{{ $interiorGallery['order'] }}"
                                                                class="form-control" placeholder="Enter Order"
                                                                name="interiorGallery[{{ $interior_count }}][order]">
                                                        </td>

                                                        <td>

                                                            <a class="btn btn-sm btn-danger" id="fix_delete"
                                                                onclick="deleteGallery({{ $interiorGallery['id'] }})"
                                                                title="Remove row">X Remove</a>
                                                ...
                                                <tr class="interior-item-row" style="border-bottom: solid 1px black">
                                                    <td>
                                                        ...
                                                        <div
                                                            ...
                                                            <label class="custom-file-label" for="interiorGallery">Choose
                                                                file</label>
                                                        </div>
                                            ...
                                            <tr id="hiderow">
                                                <td colspan="16">
                                                    <a id="addRowInterior" href="javascript:;"class="btn btn-info btn-sm"
                                                        title="Add a row">Add New</a>
                                                </td>
                                            </tr>
                                        </table>
        ...
        $(document).ready(function() {
            ...
            $("#addRowExterior").click(function() {
                ...
                $(".exterior-item-row:last").after(
                    ...
                    '<a class="exteriorRemove mybtn btn btn-danger btn-sm" href="javascript:;"  title="Remove row"> x Remove</a>' +
                    '</td><input type="hidden"  name="exteriorGallery[' + exteriorId +
            ...
            $("#addRowInterior").click(function() {
                ...
                $(".interior-item-row:last").after(
                    '<tr class="interior-item-row" style="border-bottom: solid 1px black">' +
                    '<td class="main_td">' +
                    '<input type="file" class="form-control exterior-file-upload"  accept="image/*" data-target="interiorPreviewImage' +
                    interiorId + '" name="interiorGallery[' + interiorId + '][file]" required>' +
                    '<img id="interiorPreviewImage' + interiorId +
                    '" src="#" alt="Image Preview" style="display: none; max-width: 100px; max-height: 100px;" />' +
                    '</td>' +
                    '<td class="main_td"><input type="text" class="form-control" placeholder="Enter Title" name="interiorGallery[' +
                    interiorId + '][title]" required></td>' +
                    '<td class="main_td"><input type="number" min="0" class="form-control" placeholder="Enter Order" name="interiorGallery[' +
                    interiorId + '][order]"></td>' +
                    '<td data-title="Action" class="main_td">' +
                    '<a class="interiorRemove mybtn btn btn-danger btn-sm" href="javascript:;"  title="Remove row"> x Remove</a>' +
                    '</td><input type="hidden"  name="interiorGallery[' + interiorId +
                    '][old_gallery_id]" value="0"></tr>');
