                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select data-placeholder="Select Community" class=" form-control select1 @error('main_community_id') is-invalid @enderror" id="main_community_id" name="main_community_id" required>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select1 @error('developer_id') is-invalid @enderror" id="developer_id" name="developer_id" required>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('projectOrder') is-invalid @enderror" id="projectOrder" name="projectOrder" min="1" value="{{ $project->projectOrder }}">
                                        @error('projectOrder')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $project->permit_number }}" class="form-control @error('permit_number') is-invalid @enderror" id="permit_number" placeholder="Enter Permit Number" name="permit_number">
                                        @error('permit_number')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <p class="form-control @error('reference_number') is-invalid @enderror" id="reference_number" placeholder="Enter Reference Number" name="reference_number">{{ $project->reference_number }}</p>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" value="{{ $project->completion_date }}" class="form-control @error('completion_date') is-invalid @enderror" id="completion_date" name="completion_date">
                                ...
                                <div class="col-sm-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select1 @error('used_for') is-invalid @enderror" id="used_for" name="used_for">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="features_description">Highlights Description<small class="text-danger">(Not more 400 characters)</small></label>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select multiple="multiple" data-placeholder="Select Amenities" style="width: 100%;" class="select2 form-control @error('amenityIds') is-invalid @enderror" id="amenities" name="amenities[]">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{ $project->address }}" id="address-input" name="address" class="form-control map-input" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file   @error('clusterPlan') is-invalid @enderror">
                                            <input type="file" class="custom-file-input   @error('clusterPlan') is-invalid @enderror" id="clusterPlan" name="clusterPlan" accept="image/*">
                                        ...
                                        <img src="{{ $project->clusterPlan }}" alt="{{ $project->clusterPlan }}" width="" height="200">
                                        @endif
                                    </div>
                                </div>
