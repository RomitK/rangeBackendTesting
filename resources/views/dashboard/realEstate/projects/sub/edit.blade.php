            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-boder" method="POST" action="{{ route('dashboard.projects.subProjects.update', [$project->id,$subProject ]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $subProject->title }}" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Enter Name" name="title" required>
                                            @error('title')
                                     ...
                                     <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('is_approved') is-invalid @enderror" id="is_approved" name="is_approved">
                                                ...
                                                <option value="{{ $key }}" @if($key === $subProject->is_approved) selected @endif>{{ $value }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('status') is-invalid @enderror" id="status"
                                                ...
                                                @foreach (config('constants.statuses') as $key=>$value)
                                                    <option value="{{ $key }}" @if($subProject->status == $key) selected @endif>{{ $value }}</option>
                                                @endforeach
                                            </select>
                                            @error('status')
                                                <span class="invalid-feedback" role="alert">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('list_type') is-invalid @enderror" id="list_type"
                                                ...
                                                @foreach (config('constants.listTypes') as $key=>$value)
                                                    <option value="{{ $key }}" @if($subProject->list_type == $key) selected @endif>{{ $value }}</option>
                                                @endforeach
                                            </select>
                                            @error('list_type')
                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="overflow-hidden noSideBorder flex-grow-1">
                                                    <select data-placeholder="Select Accommodation" style="width: 100%;" class="select2 form-control @error('accommodation_id') is-invalid @enderror" id="accommodation_id" name="accommodation_id">
                                                        ...
                                                        <option value="{{ $accommodation->id }}"  @if($accommodation->id == $subProject->accommodation_id) selected @endif>{{ $accommodation->name }}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select data-placeholder="Select Bedrooms" style="width: 100%;" class="form-control select1 @error('bedrooms') is-invalid @enderror" id="bedrodoms" name="bedrooms" required>
                                                @foreach ($bedrooms as $value)
                                                <option value="{{ $value }}" @if($subProject->bedrooms == $value) selected @endif>{{ $value }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $subProject->starting_price }}" class="form-control @error('starting_price') is-invalid @enderror" id="starting_price"  name="starting_price" required>
                                     ...
                                     <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file   @error('floorPlan') is-invalid @enderror">
                                                <input type="file" class="custom-file-input" id="floorPlan" name="floorPlan[]" accept="image/*" multiple >
                                            ...
                                            <br><br>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <a class="remove-image" onclick="return confirm('Are you sure to delete the image?')" href="{{ route('dashboard.subProjects.floorplanDestroy', [$project->id,$subProject->id, $img['id'] ]) }}" style="display: inline;">&#215;</a>
                                                </div>
                                                </div>
                                    ...
                                    <!--        <textarea id="short_description" class="summernote form-control @error('short_description') is-invalid @enderror" name="short_description">{{ $subProject->short_description }}</textarea>-->
