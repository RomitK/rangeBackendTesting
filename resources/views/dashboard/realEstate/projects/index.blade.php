                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control"
                                                id="display_on_home" name="display_on_home">
                                            ...
                                            <td class="project-actions text-right">
                                                <form method="POST"
                                                    ...
                                                    <a class="btn btn-warning btn-sm"
                                                         href="{{ config('app.frontend_url')."projects/".$project->slug }}" target="_blanket">
                                                    ...
                                                    <a class="btn btn-dark btn-sm"
                                                        href="{{ route('dashboard.projects.updateBrochure', $project->id) }}" target="_blanket">
                                                   ...
                                                   @if($project->brochure)
                                                    <a class="btn btn-dark btn-sm"
                                                        href="{{ $project->brochure }}" target="_blanket">
