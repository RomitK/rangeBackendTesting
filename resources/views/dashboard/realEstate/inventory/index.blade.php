...
@section('breadcrumb')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Primary Market Inventory Report</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/home">Home</a></li>
                        <li class="breadcrumb-item active">Primary Market Inventory Report</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                    ...
                                    class="{{ $project->inventory_update && Carbon::parse($project->inventory_update)->diffInDays(Carbon::now()) > 25 ? 'bg-danger' : '' }}">
                                            ...
                                            <td>
                                                <a class="btn btn-dark btn-sm"
                                                    href="{{ route('dashboard.inventoryReport.list', $project->id) }}">
