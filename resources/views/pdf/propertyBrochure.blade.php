...
<body>
  ...
  list($amenitiePieces2, $amenitiePieces1) = array_chunk($amenities,
  ceil(count($amenities) / 2));
  @endphp
  <header class="header">
  ...
  <section class>
    ...
    <table style="width:100%;">
      <thead>
        ...
        <tr>
          <td>
            <p class="tblTdText text-secondary" style="list-style-type: disc;">&bull; {{ $amenitiePiece1['name'] }} </p>
          </td>
          <td>
            <p class="tblTdText text-secondary" style="list-style-type: disc;">&bull; {{ $amenitiePieces2[$key]['name'] }} </p>
          </td>
        </tr>
        @endforeach
      </thead>
